...
public interface TransactionRepository extends MongoRepository<Transaction, String> {
    ...
    List<Transaction> findByAccountIdAndUserIdOrderByBookingDateDesc(
            String accountId, ObjectId userId);
    ...
    List<Transaction> findByRemittanceInformationUnstructuredAndCategoryIdIsNull(
    ...
    List<Transaction> findByAccountIdAndUserIdAndBookingDateBetweenOrderByBookingDateDesc(
            String accountId, ObjectId userId, String startDate, String endDate);
